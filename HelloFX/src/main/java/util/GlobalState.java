...
public class GlobalState {
    ...
    public static final String EVENT_HANDLING_FILE = "eventHandling";
    public static final String CSS_STYLING_FILE = "cssStyling";
    public static final String SCENE_1_FILE = "scene1";
    public static final String SCENE_2_FILE = "scene2";
